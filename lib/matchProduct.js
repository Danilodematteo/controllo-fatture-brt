...
// Il listino va passato come parametro (vedi lib/pesoStore.js) così può essere
// modificato da chi usa l'app, senza dover toccare il codice.
 ...
 */
function matchProduct(nomeWoo, listino) {
  if (!listino || !listino.length) return null;
